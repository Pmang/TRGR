...
public class Pauser : MonoBehaviour
{
	...
	private static String playedBgm;
	...
	{
		playedBgm = BgmManager.Instance.GetPlayingBgmName();
		BgmManager.Instance.Stop();
		BgmManager.Instance.SePlay("Pause");
	...
	public static void Resume()
	{
		...
		BgmManager.Instance.Play(playedBgm, true);
		BgmManager.Instance.SePlay("Pause");
		Debug.Log(playedBgm);
	}
}