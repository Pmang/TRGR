...
/*
 * モブの基本的な動作を行うスクリプトです。
 * 2015/9/1 ITスペシャリスト学科 ゲームクリエイターコース 2年 藤田 勇気
 */
public class Mob_G : MobBase
{
    ...
    public override void Start()
    {
        ...
        //トリガー準備
        attack1_Id = Animator.StringToHash("attack1");

        attack2_Id = Animator.StringToHash("attack2");
